...
echo '
            <div class="card-body">
             ...
             <div class="row d-flex justify-content-center">
              ...
              <div class="col-lg-4"> 
                <i class="far fa-calendar-alt"></i> <b>' . $row['date'] . '</b>, <b>' . $row['time'] . '</b>
			  </div>
              <div class="col-lg-4"> 	
            ...
            <h6 id="comments"><i class="fa fa-comments"></i> Comments (' . post_commentscount($row['id']) . ')</h6>
';
?>
...
if ($count <= 0) {
    ...
    while ($comment = mysqli_fetch_array($q)) {
        ...
        <div class="card mb-3">
          <div class="row">
            <div class="col-md-3">
              <img src="' . $aavatar . '" alt="' . $aauthor . '" style="width: 100%; height: 100%;">
            </div>
            <div class="col-md-9">
              <div class="card-body">
                <h6 class="card-title"><i class="fa fa-user"></i> ' . $aauthor . ' ' . $arole . '</h6>
                <p class="card-text">' . emoticons($comment['comment']) . '</p>
                <p class="card-text"><small class="text-muted"><i class="fa fa-calendar-alt"></i> ' . $comment['date'] . ', ' . $comment['time'] . '</small></p>
              </div>
            </div>
          </div>
        </div>
