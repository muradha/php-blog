...
?>
    <li class="nav-item dropdown">
        <a href="#" class="nav-link link-dark dropdown-toggle" data-bs-toggle="dropdown"><i class="fas fa-user"></i> Profile <span class="caret"></span></a>
		<ul class="dropdown-menu">
            <li><a class="dropdown-item" href="profile.php"><i class="fas fa-cog"></i> Settings</a></li>
<?php
        if ($rowu['role'] == 'Admin' || $rowu['role'] == 'Editor') {
?>
			<li><a class="dropdown-item" href="admin" target="_blank"><i class="fas fa-toolbox"></i> Admin Panel</a></li>
<?php
        }
?>  
...
<?php
    ...
    if ($count <= 0) {
        ...
        while ($row = mysqli_fetch_assoc($run)) {
            ...
            $image = "";
            if($row['image'] != "") {
                $image = '<img src="' . $row['image'] . '" alt="' . $row['title'] . '" style="width: 100%; height: 90%;">';
            } else {
								  ...
								  <div class="row g-0">
								    ...
								    <div class="col-md-8">
								      <div class="card-body">
								        ...
								        <p class="card-text">
                                            <small>
                                                <i class="fas fa-calendar"></i> ' . $row['date'] . ', ' . $row['time'] . '<br />
				...
				echo '
                                <div class="mb-3 bg-light rounded">
								  <div class="row g-0">
								    <div class="col-md-3">
								      <a href="post.php?id=' . $row['id'] . '">
								        <img src="' . $acavatar . '" alt="' . $acuthor . '" style="width: 100%; height: 75%;">
								      </a>
								    </div>
								    <div class="col-md-9">
								      <div class="card-body">
                                        <h6 class="card-title">' . $acuthor . '' . $badge . '</h6>
								        <p class="card-text">
                                            <small>
                                                <i class="fas fa-calendar"></i> ' . $row['date'] . ', ' . $row['time'] . '<br />
